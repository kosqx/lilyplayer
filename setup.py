...
setup(
    ...
    packages=find_packages('lilyplayer'),
    data_files=[
        ...
        ('/usr/share/lilyplayer/icons/subsrc',     glob.glob('data/subsrc/*.png')),
        ('/usr/share/lilyplayer/icons/languages',  glob.glob('data/languages/*.png')),
