...
class GStreamerPlayer(Player):
    ...
    def snapshot(self):
        ...
        open('/home/kosqx/lily_%s.png' % time.strftime('%Y-%m-%d_%H:%M:%S'), 'wb').write(data)
        return data
...
class Main(QApplication): 
    ...
    def start_stop(self):
            ...
            #self.player.open(str(self.entry.text()))
        #else: 
            #self.player.close()
